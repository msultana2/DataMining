...
health = ['health', 'brain', 'admits', 'deformities', 'cause', 'child', 'mom', 'pregnant-women', 'disease']
spread = ['america', 'officials', 'virus', 'spread', 'endemic', 'threat', 'authorities', 'public', 'stay']
